...
1. タイトル
SEOと情緒的魅力を両立する魅力的なタイトルを作成し、マークダウンの見出し1（#）で出力します。

【タイトルのフォーマット】
# 【温泉地名】キャッチーなフレーズ｜{persona_keyword}におすすめの露天風呂付き客室

例:
# 【伊豆高原】絶景と美食に酔いしれる至福の時間｜50代夫婦におすすめの露天風呂付き客室
# 【箱根】富士を望む贅沢な湯浴み｜カップルにおすすめの露天風呂付き客室

必須要素:
- 【温泉地名】を冒頭に配置
- 検索されやすいキーワード（露天風呂付き客室、{persona_keyword}）を含む
- 情緒的で魅力的なフレーズを入れる
- 「｜」で区切り、後半にターゲットを明示
